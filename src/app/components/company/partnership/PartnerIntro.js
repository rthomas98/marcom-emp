...
const PartnerIntro = () => {
  return (
    <section class="px-[5%] py-16 md:py-24 lg:py-28">
      <div class="container mx-auto mb-12 grid grid-cols-1 items-start justify-between gap-x-12 gap-y-8 md:mb-18 md:grid-cols-2 md:gap-x-12 md:gap-y-8 lg:mb-20 lg:gap-x-20">
